...
?>
<form action="<?php echo JRoute::_('index.php?option=com_sptransfer&view=log'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			<label class="filter-hide-lbl" for="filter_begin"><?php echo JText::_('COM_SPTRANSFER_BEGIN_LABEL'); ?></label>
			...
			<label class="filter-hide-lbl" for="filter_end"><?php echo JText::_('COM_SPTRANSFER_END_LABEL'); ?></label>
			...
			<select name="filter_tables_id" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_SPTRANSFER_SELECT_TABLES_ID');?></option>
				<?php echo JHtml::_('select.options', JFormFieldTables::getOptions(), 'value', 'text', $this->state->get('filter.tables_id'));?>
			</select>
                        <select name="filter_state" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_SPTRANSFER_SELECT_STATES_ID');?></option>
			...
			<tr>
				<th class="title" width="10%">
                                ...
                                <th class="title" width="20%">
                                    <?php echo JText::_('COM_SPTRANSFER_FIELD_EXTENSION_STATE_LABEL'); ?>
				</th>
				<th width="40%" class="nowrap">
                                    <?php echo JText::_('COM_SPTRANSFER_FIELD_EXTENSION_NOTE_LABEL'); ?>
				</th>
				<th width="10%" class="nowrap">
                                    <?php echo JText::_('COM_SPTRANSFER_FIELD_EXTENSION_SOURCE_ID_LABEL'); ?>
				</th>
				<th width="10%" class="nowrap">
                                    <?php echo JText::_('COM_SPTRANSFER_FIELD_EXTENSION_DESTINATION_ID_LABEL'); ?>
				</th>
				<th width="10%" class="nowrap">
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td class="left">
					<?php echo $item->extension_name.'_'.$item->name; ?>
                                ...
                                <td class="left">
					<?php echo JText::_('COM_SPTRANSFER_STATE_'.$item->state);?>
				</td>
				<td class="left">
					<?php echo $item->note;?>
				</td>
