$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"BlueCenturyLTD", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
		...
		readMore: "Show on Twitter", // read more message to be show after the tweet content
